...
const EN = {
  ...
  "import.perFileTitle": "Detected files",
  "import.detected": "Detected",
  "import.rows": "rows",
  "import.encoding": "Encoding",
  "import.unknownSource": "Unknown",
  "import.skipFile": "Skip",
  "error.someFiles": "{n} file(s) could not be parsed — they were skipped.",
  ...
  "settings.viewCurrency": "Display currency",
  "settings.fxStale": "Exchange rates are {n} old and may be stale.",
...
const ZH: Record<keyof typeof EN, string> = {
  ...
  "import.perFileTitle": "已识别文件",
  "import.detected": "已识别",
  "import.rows": "笔",
  "import.encoding": "编码",
  "import.unknownSource": "未知",
  "import.skipFile": "跳过",
  "error.someFiles": "{n} 个文件无法解析——已跳过。",
  ...
  "settings.viewCurrency": "显示货币",
  "settings.fxStale": "汇率已陈旧（{n}），可能不准。",
